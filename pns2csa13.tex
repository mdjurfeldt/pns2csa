...
% AD: I don't think a figure is needed here
...
%MDJ: If we keep this section, it should go somewhere earlier
%
...
\item \textbf{Python, csa} used PyNN's original CSAConnector that is
  ...
  % AD: in the current implementation, whether these calls are 
  % one-to-one or many-to-one (with intermediate storage)
...
\caption{Benchmark results for the use of CSA in NEST through PyNN,
  ...
  mask with a probability of 0.1 for different numbers of neurons. This
  ...
  \emph{random} mask with a probability of 0.1 and varying the number of
...
% AD: I don't understand the following sentence. What would be the
%     mechanism of degradation, and how are these numbers magic?
