...
We have developed a generic connection generator interface which provides a standard way to connect a connectivity-generating library to a simulator, 
...
We also demonstrate how the simulator-independent modelling framework PyNN can transparently make use of this, 
...
As an example of a connectivity-generating library, we then give a brief
...
\subsubsection{Connectivity-generating libraries}
...
\ref{sec:conn_gen_pynn}). Grouped by the software layer in which the
