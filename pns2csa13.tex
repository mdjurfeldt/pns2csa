...
\verb|ConnectionGenerator| interface provided by the libneurosim library. We
...
The design of the novel \verb|ConnectionGenerator| interface for NEST is
...
ConnectionGeneratorModule and the PyNN CSAConnector is that value sets
...
be extracted from NEST and made available as part of libneurosim.
