...
populations are each enumerated using non-negative integer indices.
These indices
are used to specify source and target neuron identity and
constitutes an abstraction barrier between the actual elements of a
