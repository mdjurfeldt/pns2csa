...
for specifying connectivity. This has the effects that modelers need
to learn the ways of each simulator and that descriptions of
connectivity are not easily moved between simulators.  To accomodate
this, several universal description languages for neuronal network
models (e.g. PyNN, NeuroML and NineML) have been developed.
