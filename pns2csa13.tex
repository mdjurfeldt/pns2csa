...
section enables the simulator NEST to use the connection generating
libraries \verb|csa| and \verb|libcsa|.  The performance of the
coupled system is assessed by benchmarks in Section
\ref{sec:benchmarks} and we now introduce these libraries.
