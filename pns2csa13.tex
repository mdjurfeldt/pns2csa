...
\verb|libneurosim| provides the ConnectionGenerator interface (Figure
...
registry consists of two static methods in the ConnectionGenerator
interface:
...
for the ConnectionGenerator can only be used if its arity is 0 or
...
ConnectionGenerator. Examples of such synapse models are STDP or
