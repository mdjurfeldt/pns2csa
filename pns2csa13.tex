...
and extensible demonstration of CSA and 2. to experiment with new ways
...
\item \textbf{Python, csa} used PyNN's original CSAConnector that is
  ...
  implementation (from the INCF Software Center, see
  ...
  level. It connects the neurons by issuing \verb|ConvergentConnect()| calls to
  PyNEST. 
